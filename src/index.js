...
class App extends React.Component {
  ...
  componentDidMount() {
    ...
    detectFrame = (video, model) => {
		...
		var time_dil = end - start;
		console.log("Inference time: " + (time_dil));
  ...
  process_input(video_frame){
	...
	const tfimg_rsz = tf.image.resizeBilinear(tfimg, [300,300]).toInt();
    const expandedimg = tfimg_rsz.transpose([0,1,2]).expandDims();
    return expandedimg;
  };
